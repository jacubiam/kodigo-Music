...
const SearchBar = () => {
    ...
    const handleSubmit = (e) => {
        ...
        search(textCleanWords.join(" "), tokenID, setAlbums, setErrorText);
        navigator('/');
    };
    ...
    return (
        <>
            <div className="flex w-full rounded bg-white max-w-screen-md mx-auto ">
                ...
                <button type="submit" className="m-2 rounded bg-blue-600 px-4 py-2 text-white" onClick={handleSubmit}>
            ...
            <p className="w-fit text-center bg-white mt-4 mx-auto p-3 rounded-md text-gray-700" style={errorText ? { display: "block" } : { display: "none" }}>Something is wrong, check the input and try again</p>
        </>
    );
};
